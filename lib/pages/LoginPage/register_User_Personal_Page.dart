...
import 'package:smartbee_mobile/network/login_NetworkRequest.dart';

import '../homePage Components/homePage_AppBar.dart';

class register_User_Personal_Page extends StatefulWidget {
  const register_User_Personal_Page({super.key});

  @override
  State<register_User_Personal_Page> createState() =>
      _register_User_personal_pageState();
}

class _register_User_personal_pageState
    extends State<register_User_Personal_Page> {
  bool value = false;
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: () {
                              Navigator.pushNamed(
                                  context, "register_account_userpage");
                            },
                            child: Text(
                              "Đăng ký!",
                              style: TextStyle(
